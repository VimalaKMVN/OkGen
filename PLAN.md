...
> Baseline: top of `main` = tag `v0.20.0-empty-sections-single-file-bulk`.
...
## 4. Current state
- **Top of `main` = tag `v0.20.0-empty-sections-single-file-bulk`.** **Tests: 112 passing.**
...
# Tests
.venv/bin/python -m pytest tests/ -q              # currently 112
