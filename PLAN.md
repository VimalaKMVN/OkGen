...
> Baseline: top of `main` = tag `v0.19.0-eu-gta-styleheader-cartonlabel`.
...
## 4. Current state
- **Top of `main` = tag `v0.19.1-plan-sync`** (doc/tooling only on top of the `v0.19.0-eu-gta-styleheader-cartonlabel` code). **Tests: 106 passing.**
